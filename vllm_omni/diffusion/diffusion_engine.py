...
class DiffusionEngine:
    ...
    def step(self, request: OmniDiffusionRequest) -> list[OmniRequestOutput]:
        ...
        # Single-stage pipelines may return text via custom_output.
        is_text_output = isinstance(output_data, str) and output.custom_output.get("text_output") is not None
